...
const Contact = () => {
  ...
  return (
    <div
      ...
      className={
        darkMode
          ? "bg-gray-100 pt-12 pb-12"
          : "bg-black pt-12 pb-12 text-white"
      }
    >
      <div className="max-w-7xl mx-auto x-4 sm:px-6 lg:px-8 px-4">
        ...
        <div className="flex justify-between items-center md:items-stretch  flex-col md:flex-row pb-6">
            ...
            <form>
              ...
              <div className="flex justify-between ">
                <div className="underline">
                  <a href="mailto:nithinbhimavarapu1234@gmail.com">
                    Send me email directly
                  </a>
                </div>
                <button className="bg-indigo-500 text-white px-4 py-2 w-40 rounded-md hover:bg-indigo-400">
                  <a href="mailto:nithinbhimavarapu1234@gmail.com">Submit</a>
                </button>
              </div>
            </form>
          </div>
          <div className="w-full flex flex-col md:items-end  mt-12 md:mt-6">
            ...
            <a
              ...
              className="mb-12 mt-4 font-semibold text-blue-700 block uppercase"
            >
              nithinbhimavarapu1234@gmail.com
            </a>
